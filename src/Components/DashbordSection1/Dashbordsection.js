    ...
    return (
        <Container id="sectionmain">
            <Row>
                ...
                <Col sm >
                    <img src={homicon} style={{ width: "120px", marginTop: "20px", marginRight: "10px" }} />
                </Col>
                <Col sm style={{ marginTop: "10px" }}>
                    <p style={{ color: "white" }}>
                        Welcome
                        <h4 style={{ fontWeight: "bold", }}>Juan
                        </h4>
                ...
                <Col sm >
                    ...
                    <div id="next"><h6 className="dsbd">NEXT RACE</h6></div>
                    <FlipCountdown
                        yearTitle='Year'
                        monthTitle='Months'
                        dayTitle='Days'
                ...
                <Col sm style={{ marginTop: "-25px" }}>
                    <div style={{ display: "flex", JustifyContent: "center", flexDirection: "column" }}>
                        ...
                        <div>
                            <button className="rated" onClick={() => { setSmShow(true); setmodaltype("wallet") }}>TOP OP WALLET</button>
                            <button className="rated" onClick={() => { setSmShow(true); setmodaltype("Withdraw") }}>WITHDRAW</button>
