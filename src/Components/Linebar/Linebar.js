...
export default function PrimarySearchAppBar({
  ...
  const renderMobileMenu = (
    ...
    >
      <Col>
        {" "}
        <Link to="/">
          <button className="pagsses">Home</button>
        </Link>
      </Col>
      ...
      <Col>
        {" "}
        <Link to="/Dashboard">
          <button className="pagsses">Dashboard</button>
        </Link>
      </Col>
      ...
      <Col>
        {" "}
        <Link to="/HelpCenter">
          <button className="pagsses">Centre</button>
        </Link>
      </Col>
      ...
      <Col>
        {" "}
        <Link to="/Contact">
          <button className="pagsses">Contact</button>
        </Link>
      </Col>
    </Menu>
  );
  ...
  return (
    ...
    >
      <AppBar position="fixed" id="Appbarmain">
        <Modal
          size="sm"
          show={smShow}
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              <div>
                <button
                  ...
                  style={{
                    backgroundColor:
                      modaltype === "Withdraw" ? "#550d9c" : "white",
                  }}
                >
                  DEPOSIT
                </button>
            ...
            <Row id="row">
              <Col id="pagessmain">
                <Link to="/">
                  {" "}
                  <Col>
                    <button className="pagss" id="homepge">
                      <span id="hme">Home</span>
                    </button>
                  </Col>
                </Link>
                ...
                {isAuthenticated ? (
                  <Link to="/Dashboard">
                    {" "}
                    <Col>
                      <button className="pagss" id="dashbord">
                        {" "}
                        <spane id="dshbod">Dashboard</spane>
                      </button>
                    </Col>
                  </Link>
                ) : (
                  ...
                  <Link to="/">
                    ...
                    <button onClick={()=>{
                      setmodaltype1("login1")
                      setSmShow1(true)
                    }} className="pagss" id="dashbord">
                      {" "}
                      <spane id="dshbod">Dashboard</spane>
                    </button>
                    </Link>
                ...
                <Link to="/HelpCenter">
                  {" "}
                  <Col>
                    <button className="pagss" id="hcentr">
                      <span className="help">Help Centre</span>
                    </button>
                  </Col>
                </Link>
                <div className="lin"></div>
                <Link to="/Contact">
                  {" "}
                  <Col>
                    <button className="pagss" id="contactpge">
                      Contact
                    </button>
                  </Col>
                </Link>
