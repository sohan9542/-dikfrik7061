                    ...
                    <div id="mainslid">
                        <Slider {...settings}>
                            <div className="slidecard">
                                ...
                                <div className="icontexman">  <img src={boxicon} className="iconbx" /> <p className="cardp">Pattaya One Loft <br />
                                    &nbsp; &nbsp; Race 12</p></div>
                                <div className="datimemain">
                                    <span className="datime">2022-05-21</span>
                                    <span className="datime">11:03:67:23</span>
                                </div>
                                <buttton className="startRbutn">Start Racing </buttton>
                            </div>

                            <div className="slidecard">
                                <img src={boximg2} className='boximg' />
                                <div className="icontexman">  <img src={boxicon1} className="iconbx" /> <p className="cardp">Australia One Loft
                                    <br /> 
                                    &nbsp; &nbsp; Race 1</p></div>
                                <div className="datimemain">
                                    <span className="datime">2022-05-21</span>
                            ...
                            <div className="slidecard">
                                ...
                                <div className="icontexman">  <img src={boxicon2} className="iconbx" /> <p className="cardp">Pattaya One Loft <br />
                                    &nbsp; &nbsp; Race 12</p></div>
                                <div className="datimemain">
                                    <span className="datime">2022-05-21</span>
                                    <span className="datime">11:03:67:23</span>
