      ...
      <div style={{ marginTop: 100 }}>
        <Carousel variant="dark" >
          ...
          /> */}
            ...
            <div style={{ backgroundImage: `url(${Slide1pic})`, backgroundRepeat: 'no-repeat' }} className="_item_img">
              <Container>
                  ...
                  <Col xs={6}>
                    ...
                    <div>
                      ...
                      <p className="slideteaxt" >
                        One Loft Pigeon Daily
                        Fantasy Racing is Here</p>
                      <p className="secndtext">
                        A NEW <br />
                        WAY TO TRUIMPH <br />
                        THE SKY WITH VIRTUAL ONE LOFT <br />
                        RACING <br />
                        <button className="startbtn" onClick={() => {setSmShow(true)}}>Get Started Now</button>
                      </p>
                    </div>
                  </Col>
                  <Col xs={5}>
                  ...
                  <Col xs={6}>
                    ...
                    <div style={{position:"relative"}}>
                      ...
                      <p className="secndtext">
                        ...
                        THE SKY WITH VIRTUAL ONE LOFT <br />
                        RACING <br />
                        <button className="startbtn" onClick={() => {setSmShow(true)}}>Start Racing</button>
                      </p>
                    </div>
                  </Col>
                  <Col xs={6}>
              ...
              <Container>
               ...
               <img src={SlideIcon2} className="iconslide3" />
                   ...
                   <div style={{display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center",}}>
                     ...
                     <p style={{textAlign:"center", width:"400px"}}  className="slideteaxt" id="slidetextID">
                       Enter Variour <br /> One Loft Races</p>
                     <p  style={{textAlign:"center"}} className="secndtext" id="secndtextID">
                       AND STAND A CHANCE <br /> TO WIN BIG! 
                       
                     </p>
                     <button className="startbtn" onClick={() => {setSmShow(true)}}>Start Racing Now</button>
                   </div>
