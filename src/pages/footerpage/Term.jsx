...
import PrimarySearchAppBar from "../../Components/Linebar/Linebar";
    ...
    <div>
      ...
      <div style={{ minHeight: "100vh", paddingTop: "140px" }}>
        <Container>
          ...
          <p>Last updated: 2021-10-15</p>
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>1. Introduction</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              Welcome to Compupigeon Pty Ltd (“Company”, “we”, “our”, “us”)!
              These Terms of Service (“Terms”, “Terms of Service”) govern your
              use of our website located at www.compupigeon.com (together or
              individually “Service”) operated by Compupigeon Pty Ltd. Our
            ...
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              ...
              at webmaster@compupigeon.co.za so we can try to find a solution.
              These Terms apply to all visitors, users and others who wish to
              access or use Service.
            </h6>
          </div>
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>2. Communications</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              ...
              emailing at webmaster@compupigeon.co.za.
            </h6>
          </div>
          <div style={{ width: "100%", padding: "10px 0" }}>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>4.Content</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
            ...
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              Compupigeon Pty Ltd has the right but not the obligation to
              monitor and edit all Content provided by users. In addition,
              Content found on or through this Service are the property of
              Compupigeon Pty Ltd or used with permission. You may not
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>5.Prohibited Uses</h5>
            ...
            <ul>
              <li style={{ fontSize: "12px", fontWeight: "500" }}>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>6. Analytics</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>7. No Use By Minors</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>8. Accounts</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
            ...
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              ...
              that is offensive, vulgar or obscene. We reserve the right to
              refuse service, terminate accounts, remove or edit content, or
              cancel orders in our sole discretion.
            </h6>
          </div>
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>9. Intellectual Property</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              Service and its original content (excluding Content provided by
              users), features and functionality are and will remain the
              exclusive property of Compupigeon Pty Ltd and its licensors.
              ...
              consent of Compupigeon Pty Ltd.
            </h6>
          </div>
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>10. Copyright Policy</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              ...
              to webmaster@compupigeon.co.za, with the subject line: “Copyright
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            ...
            <ul>
              ...
              <li style={{ fontSize: "12px", fontWeight: "500" }}>
                ...
                at webmaster@compupigeon.co.za.
              </li>
            </ul>
          </div>
          <div style={{ width: "100%", padding: "10px 0" }}>
            ...
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              ...
              at webmaster@compupigeon.co.za or via third party sites and tools
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>13. Links To Other Web Sites</h5>
            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              Our Service may contain links to third party web sites or services
              that are not owned or controlled by Compupigeon Pty Ltd.
              Compupigeon Pty Ltd has no control over, and assumes no
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>14. Disclaimer Of Warranty</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>15. Limitation Of Liability</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>16. Termination</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>17. Governing Law</h5>

            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              These Terms shall be governed and construed in accordance with the
              laws of Cape Town , South Africa, which governing law applies to
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>18. Changes To Service</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>19. Amendments To Terms</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>20. Waiver And Severability</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>21. Acknowledgement</h5>
          ...
          <div style={{ width: "100%", padding: "10px 0" }}>
            <h5 style={{ fontWeight: "600" }}>22. Contact Us</h5>

            <h6 style={{ fontSize: "12px", fontWeight: "500" }}>
              Please send your feedback, comments, requests for technical
              support by email: webmaster@compupigeon.co.za. These Terms of
              Service were created for www.compupigeon.com by PolicyMaker.io on
              2021-10-15.
            </h6>
          </div>
        </Container>
